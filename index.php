        ...
        <div class="flex flex-wrap items-center justify-between gap-8">
            ...
            <div class="w-full lg:w-5/12 space-y-6">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    Track your internship journey with our comprehensive attendance and evaluation system. Designed to make your OJT experience seamless and organized.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-gray-600">Easy Attendance</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 rounded-lg bg-blue-100 flex items-center justify-center">
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-6">
            ...
            <div>
                <button id="btnLogin" 
                    ...
                    <svg x-show="loading" class="animate-spin h-5 w-5" xmlns="http://www.w3.dom/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                </button>
            ...
            <div class="text-center">
                <a href="forgot_password.php" class="text-sm text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200 font-medium">
